...
Reads DATABASE_URL from the application settings (.env) so the connection
string is defined in a single place.
"""
...
# Override sqlalchemy.url with the value from our .env / settings
